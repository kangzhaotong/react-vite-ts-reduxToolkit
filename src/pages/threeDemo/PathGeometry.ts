...
class PathGeometry extends BufferGeometry {
    ...
    */
    constructor(initData: any = 3000, generateUv2: any = false) {
        super();
    ...
    _initByMaxVertex(maxVertex: number, generateUv2: boolean) {
    ...
    _initByData(pathPointList: any, options = {}, usage: any, generateUv2: any) {
     ...
     */
    update(pathPointList: any, options: { width?: number; progress?: number; arrow?: boolean; side?: string; } = {}) {
    ...
    _resizeAttribute(name: any, len: any) {
        let attribute: any = this.getAttribute(name);
    ...
    _resizeIndex(len: any) {
        let index: any = this.getIndex();
    ...
    _updateAttributes(position: any, normal: any, uv: any, uv2: any, indices: any) {
        this._resizeAttribute('position', position.length);
        const positionAttribute: any = this.getAttribute('position');
        ...
        const normalAttribute: any = this.getAttribute('normal');
        ...
        const uvAttribute: any = this.getAttribute('uv');
        ...
        if (uv2) {
            ...
            const uv2Attribute: any = this.getAttribute('uv2');
        ...
        const indexAttribute: any = this.getIndex();
...
function generatePathVertexData(pathPointList: any, options: any, generateUv2 = false) {
    ...
    function addVertices(pathPoint: any) {
        ...
        if (sharpCorner) {
            ...
            let longerOffset: any; let longEdge: any;
    ...
    function addStart(pathPoint: any) {
        const dir = pathPoint.dir;
        const up = pathPoint.up;
        const _right = pathPoint.right;
